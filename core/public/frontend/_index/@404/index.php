...
<body>
	<div id="level">
		<div id="content">
			...
			<div id="title">
				<h1>This is the Technical Problems Page.<br />Or any other page.</h1>
				<p>It's free for comercial and non-comercial projects. And I promise, I wouldn't be mad if you link to my site:)</p>
			</div>
		</div>
	</div>
</body>
