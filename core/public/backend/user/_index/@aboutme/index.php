  ...
  <body>
        ...
        <div class="row">
          <div class="col-md-8 offset-2">
            <div class="panel panel-default">
              <div class="panel-heading panel-heading-divider">Edit About Me<span class="icon s7-lock"></span><span class="indicator"></span></div>
              <div class="panel-body">
                <form method="post" id="save">
                  <div class="form-group row">
                    <label class="col-3 col-form-label text-right">Work</label>
                    <div class="col-6">
                      <input type="text" name="work" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-3 col-form-label text-right">Birthday</label>
                    <div class="col-6">
                      <input type="date" name="birthday" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-3 col-form-label text-right">Phone</label>
                    <div class="col-6">
    ...
    <script type="text/javascript">
      ...
      $('#save').submit(function(){
            ...
            $.ajax({
                url: '<?php echo MED_API; ?>/acces/backend/user/@aboutme/index.php',
                type: 'POST',
