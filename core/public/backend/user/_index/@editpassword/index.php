  ...
  <?php require('public/backend/user/_fragment/header.php'); ?>
              ...
              <div class="panel-body">
                <form method="post" id="save">
                  <div class="form-group row">
                    <label class="col-3 col-form-label text-right">Old Password</label>
                    <div class="col-6">
                      <input name="oldpassword" type="text" placeholder="...." class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-3 col-form-label text-right">New Password</label>
                    <div class="col-6">
                      <input name="newpassword" type="password" class="form-control" require>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-3 col-form-label text-right">Repeat Password</label>
                    <div class="col-6">
                      <input name="reppassword" type="password" class="form-control" require>
                      <button type="submit" class="btn btn-primary" style="width: 100%;margin-top: 5%;">Save <span class="icon s7-check"></span></button>
                    </div>
                    </div>
                </form>
              </div>
    ...
    <script type="text/javascript">
      ...
      $('#save').submit(function(){
          ...
          $.ajax({
              url: '<?php echo MED_API; ?>/acces/backend/user/@editpassword/index.php',
              type: 'POST',
