...
$perintah = new CORE();
	...
	$sql = $perintah->getDB()->query("SELECT postid, userid,content,date FROM post WHERE
																		userid IN(SELECT toid FROM follow WHERE fromid = '$sessionid')
																		or userid = '$sessionid' ORDER BY postid DESC");
            ...
            <div class="col-12">
                  <div class="panel-body" style="margin: 1%;">
                      ...
                      <?php
                        ...
                        $sqlcom = $perintah->getDB()->query("SELECT postid, userid, comment,date FROM post_comment WHERE postid = '$result->postid'");
